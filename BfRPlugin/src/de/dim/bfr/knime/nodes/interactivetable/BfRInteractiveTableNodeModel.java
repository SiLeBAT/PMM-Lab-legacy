 ...
 */
public class BfRInteractiveTableNodeModel extends NodeModel
     ...
     * output port.
     */
    public BfRInteractiveTableNodeModel() {
        super(1, 1);
     ...
     */
    protected BfRInteractiveTableNodeModel(final PortType[] inPortTypes) {
