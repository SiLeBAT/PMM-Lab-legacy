 ...
 ******************************************************************************/
package de.dim.bfr.knime.nodes.r.prim.forecast;
 ...
 * @author 
 */
public class PrimaryForecasterNodeFactory 
...
{
    return new PredictorNodeModel(this.getClass(), PluginUtils.PRIMARY_FORECASTER);
