 ...
 ******************************************************************************/
package de.dim.bfr.knime.nodes.r.sec.estimate;
 ...
 * @author 
 */
public class SecondaryEstimationNodeFactory 
...
{
    return new PredictorNodeModel(this.getClass(), PluginUtils.SECONDARY_ESTIMATION);
