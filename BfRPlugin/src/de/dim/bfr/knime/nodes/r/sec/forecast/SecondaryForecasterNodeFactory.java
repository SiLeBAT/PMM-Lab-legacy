 ...
 ******************************************************************************/
package de.dim.bfr.knime.nodes.r.sec.forecast;
 ...
 * @author 
 */
public class SecondaryForecasterNodeFactory 
    ...
    {
        return new PredictorNodeModel(this.getClass(), PluginUtils.SECONDARY_FORECASTING);
    }
