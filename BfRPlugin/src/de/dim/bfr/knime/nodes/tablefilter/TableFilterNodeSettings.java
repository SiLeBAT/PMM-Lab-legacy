 ...
 * @author Heiko Hofer
 */
public final class TableFilterNodeSettings {
    ...
    private static final String CFG_FILTER_EXCLUDE = "filterType";
    ...
    public void setExcludeFilter(boolean m_exclude) {
    ...
    public void loadSettings(final NodeSettingsRO settings)
        ...
        m_exclude = settings.getBoolean(CFG_FILTER_EXCLUDE);
    }
    ...
    public void loadSettingsForDialog(final NodeSettingsRO settings) {
        m_exclude = settings.getBoolean(CFG_FILTER_EXCLUDE, false);
    ...
    public void saveSettings(final NodeSettingsWO settings) {
        settings.addBoolean(CFG_FILTER_EXCLUDE, m_exclude);
    ...
    private void readColumnPropsFromConfig(final NodeSettingsRO cfg)
        ...
        for (String key : cfg.keySet()) {
            ...
            ColProperty prop = new ColProperty(cfg.getNodeSettings(key));
            if(DateAndTimeCell.TYPE.equals(prop.getColumnSpec().getType()))
        		prop.setSkipThisColumn(true);
            m_colProps.put(col, prop);
        }
    }
}
