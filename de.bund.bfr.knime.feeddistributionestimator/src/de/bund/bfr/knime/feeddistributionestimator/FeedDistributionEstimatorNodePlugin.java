 ...
 */
public class FeedDistributionEstimatorNodePlugin extends Plugin {
    // The shared instance.
    private static FeedDistributionEstimatorNodePlugin plugin;

    /**
     * The constructor.
     */
    public FeedDistributionEstimatorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FeedDistributionEstimatorNodePlugin getDefault() {
        return plugin;
    }
