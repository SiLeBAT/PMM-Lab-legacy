 ...
 */
public class AgentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.bund.bfr.pcml10.AgentDocument
{
     ...
     */
    public de.bund.bfr.pcml10.AgentDocument.Agent getAgent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.bund.bfr.pcml10.AgentDocument.Agent target = null;
            target = (de.bund.bfr.pcml10.AgentDocument.Agent)get_store().find_element_user(AGENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAgent(de.bund.bfr.pcml10.AgentDocument.Agent agent)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (de.bund.bfr.pcml10.AgentDocument.Agent)get_store().add_element_user(AGENT$0);
            }
            target.set(agent);
        }
    }
     ...
     */
    public de.bund.bfr.pcml10.AgentDocument.Agent addNewAgent()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public static class AgentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.bund.bfr.pcml10.AgentDocument.Agent
    {
        ...
        public double getQuantity()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(QUANTITY$6);
                if (target == null)
                {
                    return 0.0;
                }
        ...
        public org.apache.xmlbeans.XmlDouble xgetQuantity()
        {
            synchronized (monitor())
            {
                ...
                target = (org.apache.xmlbeans.XmlDouble)get_store().find_attribute_user(QUANTITY$6);
                return target;
            }
        }
        ...
        public boolean isSetQuantity()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(QUANTITY$6) != null;
            }
        }
        ...
        public void setQuantity(double quantity)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(QUANTITY$6);
                }
        ...
        public void xsetQuantity(org.apache.xmlbeans.XmlDouble quantity)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlDouble)get_store().add_attribute_user(QUANTITY$6);
                }
                target.set(quantity);
            }
        }
