...
public class ProcessParametersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.bund.bfr.pcml10.ProcessParameters
{
    ...
    private static final javax.xml.namespace.QName STEPWIDTH$6 = 
        new javax.xml.namespace.QName("", "step-width");
    ...
    public double getStepWidth()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STEPWIDTH$6);
            if (target == null)
            {
                return 0.0;
            }
    ...
    /**
     * Gets (as xml) the "step-width" attribute
     */
    public org.apache.xmlbeans.XmlDouble xgetStepWidth()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlDouble target = null;
            target = (org.apache.xmlbeans.XmlDouble)get_store().find_attribute_user(STEPWIDTH$6);
            return target;
        }
    }
    
    /**
     * True if has "step-width" attribute
     */
    public boolean isSetStepWidth()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(STEPWIDTH$6) != null;
        }
    }
    
    /**
     * Sets the "step-width" attribute
     */
    public void setStepWidth(double stepWidth)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STEPWIDTH$6);
            }
            target.setDoubleValue(stepWidth);
        }
    }
    
    /**
     * Sets (as xml) the "step-width" attribute
     */
    public void xsetStepWidth(org.apache.xmlbeans.XmlDouble stepWidth)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDouble)get_store().add_attribute_user(STEPWIDTH$6);
            }
            target.set(stepWidth);
        }
    }
    
    /**
     * Unsets the "step-width" attribute
     */
