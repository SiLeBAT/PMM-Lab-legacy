 ...
 */
public class RegionVisualizerNodePlugin extends Plugin {
    // The shared instance.
    private static RegionVisualizerNodePlugin plugin;

    /**
     * The constructor.
     */
    public RegionVisualizerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RegionVisualizerNodePlugin getDefault() {
        return plugin;
    }
