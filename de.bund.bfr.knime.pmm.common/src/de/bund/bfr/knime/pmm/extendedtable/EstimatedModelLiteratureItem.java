...
public class EstimatedModelLiteratureItem implements PmmXmlElementConvertable {
	...
	public EstimatedModelLiteratureItem(final String author, final Integer year, final String title, final String abstractText,
	...
	public EstimatedModelLiteratureItem(final Element el) {
	...
	public EstimatedModelLiteratureItem(final LiteratureItem lit) {
