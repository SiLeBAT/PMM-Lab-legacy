...
public class MLiteratureItem implements LiteratureItemI, PmmXmlElementConvertable {
	...
	public MLiteratureItem(final String author, final Integer year, final String title, final String abstractText,
	...
	public MLiteratureItem(final Element el) {
	...
	public MLiteratureItem(final LiteratureItemI lit) {
