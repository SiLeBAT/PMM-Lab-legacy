 ...
 */
public class DataEditNodePlugin extends Plugin {
    // The shared instance.
    private static DataEditNodePlugin plugin;

    /**
     * The constructor.
     */
    public DataEditNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DataEditNodePlugin getDefault() {
        return plugin;
    }
