 ...
 */
public class DataViewAndSelectNodePlugin extends Plugin {
	// The shared instance.
	private static DataViewAndSelectNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public DataViewAndSelectNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static DataViewAndSelectNodePlugin getDefault() {
		return plugin;
	}
