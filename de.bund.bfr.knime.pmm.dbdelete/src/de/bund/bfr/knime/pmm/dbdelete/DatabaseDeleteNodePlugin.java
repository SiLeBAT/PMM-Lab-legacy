 ...
 */
public class DatabaseDeleteNodePlugin extends Plugin {
    // The shared instance.
    private static DatabaseDeleteNodePlugin plugin;

    /**
     * The constructor.
     */
    public DatabaseDeleteNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DatabaseDeleteNodePlugin getDefault() {
        return plugin;
    }
