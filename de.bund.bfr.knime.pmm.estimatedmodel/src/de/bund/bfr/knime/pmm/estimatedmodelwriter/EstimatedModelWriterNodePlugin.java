 ...
 */
public class EstimatedModelWriterNodePlugin extends Plugin {
    // The shared instance.
    private static EstimatedModelWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public EstimatedModelWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EstimatedModelWriterNodePlugin getDefault() {
        return plugin;
    }
