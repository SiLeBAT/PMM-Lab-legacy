 ...
 */
public class EstimatedModelReaderNodePlugin extends Plugin {
    // The shared instance.
    private static EstimatedModelReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public EstimatedModelReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EstimatedModelReaderNodePlugin getDefault() {
        return plugin;
    }
