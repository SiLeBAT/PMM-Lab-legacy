 ...
 */
public class FittedParameterViewNodePlugin extends Plugin {
	// The shared instance.
	private static FittedParameterViewNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public FittedParameterViewNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static FittedParameterViewNodePlugin getDefault() {
		return plugin;
	}
