 ...
 */
public class ForecastStaticConditionsNodePlugin extends Plugin {
    // The shared instance.
    private static ForecastStaticConditionsNodePlugin plugin;

    /**
     * The constructor.
     */
    public ForecastStaticConditionsNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ForecastStaticConditionsNodePlugin getDefault() {
        return plugin;
    }
