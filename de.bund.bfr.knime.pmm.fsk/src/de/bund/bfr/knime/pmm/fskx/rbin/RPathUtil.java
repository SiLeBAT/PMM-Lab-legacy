...
public final class RPathUtil {
    ...
    private static void findSystemRWindows() {
        FileFilter ff = pathname -> pathname.isDirectory() && pathname.getName().startsWith("R-");
     ...
     *
     * @return the R installation directory or <code>null</code> if no packaged installation was
     * found
     */
    ...
    /**
     * Returns the path to the executable of an R installation in the operating system if one
     * exists. The search is performed by looking at common places such as <tt>/usr/lib</tt> under
     * Linux or <tt>C:/Program Files/</tt> under Windows.
     *
     ...
     * performed by looking at common places such as <tt>/usr/lib</tt> under Linux or <tt>C:/Program
     * Files/</tt> under Windows.
     *
