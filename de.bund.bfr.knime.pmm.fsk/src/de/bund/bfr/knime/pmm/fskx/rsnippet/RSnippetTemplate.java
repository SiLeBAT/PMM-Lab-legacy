...
public class RSnippetTemplate {
  ...
  RSnippetSettings getSnippetSettings() {
  ...
  public void saveSettings(final NodeSettingsWO settings) {
    ...
    m_snippetSettings.saveSettings(settings.addNodeSettings(SNIPPET));
  }
  ...
  public void loadSettings(final NodeSettingsRO settings) {
    try {
      ...
      m_metaCategory = metaCategory == null ? RSnippetTemplate.class : Class.forName(metaCategory);
    ...
    } catch (final ClassNotFoundException | InvalidSettingsException e) {
