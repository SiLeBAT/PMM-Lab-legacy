...
import de.bund.bfr.knime.pmm.fskx.rsnippet.RSnippetNodePanel;
import de.bund.bfr.knime.pmm.fskx.rsnippet.RSnippetTemplate;

/**
 * The default implementation of {@link TemplateController}. It provides methods to get a preview
 * and to replace the setting of a java snippet by the settings of a template.
 *
 * @author Heiko Hofer
 */
public class DefaultTemplateController implements TemplateController {
     ...
     */
    public DefaultTemplateController(final RSnippetNodePanel model, final RSnippetNodePanel preview) {
        m_model = model;
        m_preview = preview;
    }
    ...
    /**
     * Set the spec used for the preview and applying a template to the model.
     *
    ...
    /**
     * Set the flow variables used for the preview and applying a template to the model.
     *
