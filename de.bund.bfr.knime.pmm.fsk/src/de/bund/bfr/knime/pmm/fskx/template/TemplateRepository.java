...
abstract class TemplateRepository {
   ...
   */
  public abstract Collection<de.bund.bfr.knime.pmm.fskx.rsnippet.RSnippetTemplate> getTemplates(
   ...
   */
  public abstract boolean isRemoveable(final RSnippetTemplate template);
   ...
   */
  public abstract boolean removeTemplate(final RSnippetTemplate template);
  ...
  /**
   * Get a short descriptive string about the location of the template. This should give the user an
   * idea where the template comes from. It can be a path to a file, or the name of a company with a
   * template name like "Fibonacci (KNIME)" for a template from KNIME that generates the Fibonacci
   * numbers.
   * 
   * @param template the template
   ...
   */
  public abstract String getDisplayLocation(final RSnippetTemplate template);
