...
/**
 * A component that presents a list of flow variables for the snippet dialog.
 * 
 * @author Heiko Hofer.
 */
public class RFlowVariableList extends JList<FlowVariable> {
  ...
  private static final long serialVersionUID = 5577767593318832287L;
  ...
  public void setFlowVariables(final Collection<FlowVariable> flowVars) {
    DefaultListModel<FlowVariable> fvListModel = (DefaultListModel<FlowVariable>) getModel();
    fvListModel.removeAllElements();
    flowVars.forEach(fvListModel::addElement);
  }
}
