...
public class RObjectBrowser extends JTable {
  ...
  private static final long serialVersionUID = -6628613534928226392L;

  private RObjectBrowserModel m_model;
  ...
  private static class RObjectBrowserModel extends AbstractTableModel {
    /** Generated serialVersionUID. */
    private static final long serialVersionUID = -3265812224000482115L;

    private String[] m_objectNames = new String[0];
    private String[] m_objectClasses = new String[0];
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
      return columnIndex == 0 ? m_objectNames[rowIndex] : m_objectClasses[rowIndex];
    }

    void updateData(final String[] objectNames, final String[] objectClasses) {
