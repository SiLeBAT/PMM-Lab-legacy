...
class FlowVariableRepository {
     ...
     */
    FlowVariableRepository(final Map<String, FlowVariable> input) {
        m_input = input;
     ...
     */
    Collection<FlowVariable> getInFlowVariables() {
     ...
     */
    Collection<FlowVariable> getModified() { return m_modified.values(); }

    /**
     * Get the current flow variable associated with the given name or null if a flow varaible with the given name does
     * not exist.
     *
     * @param name the name of the flow variable r null if a flow variable with the given name does noes exist.
     * @return the flow variable.
     */
    public FlowVariable getFlowVariable(final String name) {
        return m_input.containsKey(name) ? m_modified.get(name) : m_input.get(name);
    }
     ...
     */
    void put(final FlowVariable flowVar) {
