 ...
 * @author Heiko Hofer.
 */
class RSnippetSettings {

  private static final String SCRIPT = "script";
  private static final String TEMPLATE_UUID = "templateUUID";
  private static final String VERSION = "version";
  private static final String OUT_NON_NUMBERS_AS_MISSING =
      "Output non numbers (NaN, Inf, -Inf) as missing cells";
  ...
  /**
   * whether NaN, Inf and -Inf should be treated as missing values. Added in v2.10 for backward
   * compatibility.
   */
   ...
   */
  void loadSettings(final ConfigRO settings) throws InvalidSettingsException {
  ...
  /**
   * Load parameters in Dialog.
   * 
   * @param settings To load from.
   */
  void loadSettingsForDialog(final ConfigRO settings) {
    setScript(settings.getString(SCRIPT, ""));
  ...
  void loadSettings(final RSnippetSettings s) {
  ...
  /**
   * True when the R values NaN, Inf, and -Inf should be treated as missing values. Applies only to
   * R nodes with table output.
   * 
  ...
  /**
   * Set if the R values Nan, Inf and -Inf should be treated as missing values. Applies only to R
