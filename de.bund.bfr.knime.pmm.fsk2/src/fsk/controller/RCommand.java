...
/**
 * Class holding an R Command. This is a subclass of future, which means it can be executed and will
 * hold some kind of return value when done. RCommands are usually created and executed by adding
 * them to {@link RController#getCommandQueue()} using
 * {@link RCommandQueue#putRScript(String, boolean)}.
 * 
 * @author Miguel Alba
 */
public class RCommand extends CompletableFuture<REXP> {
   ...
   */
  RCommand(final String command, final boolean showInConsole) {
    m_command = command;
