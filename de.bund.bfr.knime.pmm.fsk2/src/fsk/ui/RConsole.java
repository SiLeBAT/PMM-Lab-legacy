...
public class RConsole extends JTextPane {
  ...
  private static final long serialVersionUID = -9179147450014092870L;
  ...
  public RConsole() {
    ...
    Style m_commandStyle = addStyle("Command Style", null);
    StyleConstants.setForeground(m_commandStyle, Color.darkGray);
    Style m_resultStyle = addStyle("Result Style", null);
