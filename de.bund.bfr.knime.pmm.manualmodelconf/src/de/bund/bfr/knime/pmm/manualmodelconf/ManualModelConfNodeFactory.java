...
/**
 * <code>NodeFactory</code> for the "ManualModelConf" Node.
 * 
 *
 * @author ManualModelConf
 */
public class ManualModelConfNodeFactory 
        extends NodeFactory<ManualModelConfNodeModel> {
    ...
    public ManualModelConfNodeModel createNodeModel() {
        return new ManualModelConfNodeModel();
    }
