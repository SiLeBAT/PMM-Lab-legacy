 ...
 */
public class ManualModelConfNodePlugin extends Plugin {
    // The shared instance.
    private static ManualModelConfNodePlugin plugin;

    /**
     * The constructor.
     */
    public ManualModelConfNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ManualModelConfNodePlugin getDefault() {
        return plugin;
    }
