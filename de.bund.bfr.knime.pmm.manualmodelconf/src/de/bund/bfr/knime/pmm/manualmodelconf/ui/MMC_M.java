		...
		if (SwingUtilities.isLeftMouseButton(e)) {
			...
			if (col == 1) {
				...
				if (pm != null) {
					...
					String categoryStr = (String) JOptionPane.showInputDialog(table, "Bitte eine Einheitenkategorie angeben f�r " + param + ":", "Einheit des Parameters " + param,
					...
					if (categoryStr != null) {
						...
						String unit = (String) JOptionPane.showInputDialog(null, "Bitte eine Einheit angeben f�r " + param + " (Kategorie: " + categoryStr + "):",
