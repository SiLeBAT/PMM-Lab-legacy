 ...
 */
public class MapToStringNodePlugin extends Plugin {
    // The shared instance.
    private static MapToStringNodePlugin plugin;

    /**
     * The constructor.
     */
    public MapToStringNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MapToStringNodePlugin getDefault() {
        return plugin;
    }
