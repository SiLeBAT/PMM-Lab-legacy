 ...
 */
public class MicrobialDataEditNodePlugin extends Plugin {
	// The shared instance.
	private static MicrobialDataEditNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public MicrobialDataEditNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static MicrobialDataEditNodePlugin getDefault() {
		return plugin;
	}
