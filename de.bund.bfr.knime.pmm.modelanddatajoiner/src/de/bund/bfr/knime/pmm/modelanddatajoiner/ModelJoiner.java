...
public class ModelJoiner implements Joiner, ActionListener {

	private KnimeSchema model2Schema;
	private KnimeSchema model1Schema;
	private KnimeSchema model12Schema;

	private BufferedDataTable model2Table;
	private BufferedDataTable model1Table;
	...
	public ModelJoiner(BufferedDataTable modelTable, BufferedDataTable dataTable)
			throws PmmException {
		this.model2Table = modelTable;
		this.model1Table = dataTable;
	...
	public BufferedDataTable getOutputTable(List<String> assignments,
		...
		BufferedDataContainer buf = exec.createDataContainer(model12Schema
				.createSpec());
		...
		for (int i = 0; i < usedModels.size(); i++) {
			...
			while (modelReader.hasMoreElements()) {
				...
				while (peiReader.hasMoreElements()) {
					...
					KnimeTuple seiRow = new KnimeTuple(model12Schema, modelRow,
							peiRow);
	...
	private void readModel2Table() throws PmmException {
		...
		KnimeRelationReader reader = new KnimeRelationReader(model2Schema,
				model2Table);
	...
	private void readModel1Table() throws PmmException {
		...
		KnimeRelationReader reader = new KnimeRelationReader(model1Schema,
				model1Table);
