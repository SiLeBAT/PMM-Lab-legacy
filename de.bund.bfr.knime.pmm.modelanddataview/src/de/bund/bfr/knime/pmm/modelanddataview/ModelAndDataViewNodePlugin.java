 ...
 */
public class ModelAndDataViewNodePlugin extends Plugin {
    // The shared instance.
    private static ModelAndDataViewNodePlugin plugin;

    /**
     * The constructor.
     */
    public ModelAndDataViewNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ModelAndDataViewNodePlugin getDefault() {
        return plugin;
    }
