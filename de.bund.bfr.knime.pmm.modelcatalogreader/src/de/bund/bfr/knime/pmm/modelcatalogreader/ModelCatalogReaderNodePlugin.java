 ...
 */
public class ModelCatalogReaderNodePlugin extends Plugin {
    // The shared instance.
    private static ModelCatalogReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public ModelCatalogReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ModelCatalogReaderNodePlugin getDefault() {
        return plugin;
    }
