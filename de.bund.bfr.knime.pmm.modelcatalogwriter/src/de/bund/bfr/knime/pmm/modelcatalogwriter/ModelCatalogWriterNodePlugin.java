 ...
 */
public class ModelCatalogWriterNodePlugin extends Plugin {
    // The shared instance.
    private static ModelCatalogWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public ModelCatalogWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ModelCatalogWriterNodePlugin getDefault() {
        return plugin;
    }
