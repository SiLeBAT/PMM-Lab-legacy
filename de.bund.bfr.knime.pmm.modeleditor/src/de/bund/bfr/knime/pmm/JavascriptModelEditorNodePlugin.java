 ...
 */
public class JavascriptModelEditorNodePlugin extends Plugin {
	// The shared instance.
	private static JavascriptModelEditorNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public JavascriptModelEditorNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static JavascriptModelEditorNodePlugin getDefault() {
		return plugin;
	}
}