 ...
 */
public class ModelSelectionTertiaryNodePlugin extends Plugin {
	// The shared instance.
	private static ModelSelectionTertiaryNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public ModelSelectionTertiaryNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static ModelSelectionTertiaryNodePlugin getDefault() {
		return plugin;
	}
