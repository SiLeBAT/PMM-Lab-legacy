...
/**
 * Model Plotter dialog pane. Shows just one text field for the chart title and one for constant Y0.
 * 
...
public final class ModelPlotterNodeDialogPane extends NodeDialogPane {
  ...
  private final JCheckBox headLess;
  ...
  public ModelPlotterNodeDialogPane() {
    ...
    headLess = new JCheckBox("Run Headless");

    m_y0Model = new SpinnerNumberModel(ModelPlotterViewConfig.DEF_Y0, ModelPlotterViewConfig.MIN_Y0,
        ModelPlotterViewConfig.MAX_Y0, 0.1);
    m_y0 = new JSpinner();
  ...
  protected void saveSettingsTo(NodeSettingsWO settings) throws InvalidSettingsException {
    ...
    config.setHeadLess(headLess.isSelected());
  ...
  protected void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec[] specs)
    ...
    m_allModelAreSelected.setSelected(config.isAllModelAreSelected());
    secondaryModelSelected.setSelected(config.isSecondaryModel());
