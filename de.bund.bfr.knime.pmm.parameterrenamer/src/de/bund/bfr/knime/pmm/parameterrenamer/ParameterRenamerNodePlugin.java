 ...
 */
public class ParameterRenamerNodePlugin extends Plugin {
    // The shared instance.
    private static ParameterRenamerNodePlugin plugin;

    /**
     * The constructor.
     */
    public ParameterRenamerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ParameterRenamerNodePlugin getDefault() {
        return plugin;
    }
