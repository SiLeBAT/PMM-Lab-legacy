 ...
 * @author BfR
 */
public class PdfKeeperNodePlugin extends Plugin {
    // The shared instance.
    private static PdfKeeperNodePlugin plugin;

    /**
     * The constructor.
     */
    public PdfKeeperNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PdfKeeperNodePlugin getDefault() {
        return plugin;
    }
