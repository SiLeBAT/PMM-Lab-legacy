 ...
 */
public class PredictorViewNodePlugin extends Plugin {
    // The shared instance.
    private static PredictorViewNodePlugin plugin;

    /**
     * The constructor.
     */
    public PredictorViewNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PredictorViewNodePlugin getDefault() {
        return plugin;
    }
