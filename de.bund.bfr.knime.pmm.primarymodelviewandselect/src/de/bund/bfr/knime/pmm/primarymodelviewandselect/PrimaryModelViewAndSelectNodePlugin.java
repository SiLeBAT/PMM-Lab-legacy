 ...
 */
public class PrimaryModelViewAndSelectNodePlugin extends Plugin {
    // The shared instance.
    private static PrimaryModelViewAndSelectNodePlugin plugin;

    /**
     * The constructor.
     */
    public PrimaryModelViewAndSelectNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PrimaryModelViewAndSelectNodePlugin getDefault() {
        return plugin;
    }
