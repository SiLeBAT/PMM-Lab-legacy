...
public class TupleDescription {
	...
	public TupleDescription(Element node) {
	...
	public String toString() {
		String string = String.format("TupleDescription [concentrationDescription=%s, timeDescription=%s]",
				concDesc, timeDesc);
		return string;
	}
	...
	public boolean equals(Object obj) {
		TupleDescription other = (TupleDescription) obj;
