...
public class PMFUnit {
	 ...
	 */
	public PMFUnit(double multiplier, int scale, Unit.Kind kind, double exponent) {
	...
	public String toString() {
		String string = String.format(Locale.ENGLISH, "unit [exponent=%.6f, kind=%s, multiplier=%.6f, scale=%d]",
