...
public abstract class PMFReaderNodeModelBase extends NodeModel {
	 ...
	 */
	protected PMFReaderNodeModelBase() {
	...
	private BufferedDataTable[] loadPMF(final ExecutionContext exec) throws Exception {
		...
		BufferedDataContainer[] containers = reader.read(filepath, isPMFX(), exec);
