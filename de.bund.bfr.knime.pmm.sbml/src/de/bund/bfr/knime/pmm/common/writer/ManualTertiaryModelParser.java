...
public class ManualTertiaryModelParser implements Parser {
	...
	private static ManualTertiaryModel parse(List<List<KnimeTuple>> tupleList, boolean isPMFX, String mdName,
		...
		for (int i = 0; i < firstInstance.size(); i++) {
			...
			String secDocName = String.format("%s_%s.%s", mdName, emdId, modelExtension);
