 ...
 */
public class SecondaryPredictorViewNodeFactory extends
		NodeFactory<SecondaryPredictorViewNodeModel> {
	 ...
	 */
	@Override
	public NodeView<SecondaryPredictorViewNodeModel> createNodeView(
			final int viewIndex, final SecondaryPredictorViewNodeModel nodeModel) {
		return null;
	}
