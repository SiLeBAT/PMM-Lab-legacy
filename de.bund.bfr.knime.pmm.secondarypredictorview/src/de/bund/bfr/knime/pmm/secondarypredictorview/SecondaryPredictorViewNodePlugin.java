 ...
 */
public class SecondaryPredictorViewNodePlugin extends Plugin {
	// The shared instance.
	private static SecondaryPredictorViewNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public SecondaryPredictorViewNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static SecondaryPredictorViewNodePlugin getDefault() {
		return plugin;
	}
