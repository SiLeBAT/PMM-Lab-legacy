...
import org.jlibsedml.IIdentifiable;
 ...
 /**
  * Provides support for getting line number of identifiable elements by linking an element to a line in
  *  the XML document.
  * @author radams
  *
  */
 abstract class AbstractDocumentValidator implements ISedMLValidator{
	...
	Document getDoc() {
	 ...
	 int getLineNumberOfError(String elementKind,IIdentifiable identifiable) {
		int line =  new  LineFinderUtil().getLineForElement(elementKind , identifiable.getId(), getDoc());
		return line;
	}
