 ...
 */
public class TimeSeriesCreatorNodePlugin extends Plugin {
    // The shared instance.
    private static TimeSeriesCreatorNodePlugin plugin;

    /**
     * The constructor.
     */
    public TimeSeriesCreatorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TimeSeriesCreatorNodePlugin getDefault() {
        return plugin;
    }
