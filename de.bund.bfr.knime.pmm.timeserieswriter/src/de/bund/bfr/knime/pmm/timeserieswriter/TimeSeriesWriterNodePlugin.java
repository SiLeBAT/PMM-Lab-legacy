 ...
 */
public class TimeSeriesWriterNodePlugin extends Plugin {
    // The shared instance.
    private static TimeSeriesWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public TimeSeriesWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TimeSeriesWriterNodePlugin getDefault() {
        return plugin;
    }
