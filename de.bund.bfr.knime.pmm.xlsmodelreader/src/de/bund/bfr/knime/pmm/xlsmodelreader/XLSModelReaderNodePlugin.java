 ...
 */
public class XLSModelReaderNodePlugin extends Plugin {
	// The shared instance.
	private static XLSModelReaderNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public XLSModelReaderNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static XLSModelReaderNodePlugin getDefault() {
		return plugin;
	}
