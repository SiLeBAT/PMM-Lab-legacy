 ...
 */
public class XLSTimeSeriesReaderNodePlugin extends Plugin {
	// The shared instance.
	private static XLSTimeSeriesReaderNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public XLSTimeSeriesReaderNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static XLSTimeSeriesReaderNodePlugin getDefault() {
		return plugin;
	}
