 ...
 */
public class SimpleXLSReaderNodePlugin extends Plugin {
	// The shared instance.
	private static SimpleXLSReaderNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public SimpleXLSReaderNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static SimpleXLSReaderNodePlugin getDefault() {
		return plugin;
	}
