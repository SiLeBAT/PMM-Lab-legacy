...
/**
 * Case 3c. Keeps a master {@link SBMLDocument} per tertiary model linked to n {@link SBMLDocument}s
...
public class ManualTertiaryModel {
  ...
  public ManualTertiaryModel(final String tertDocName, final SBMLDocument tertDoc,
      final List<String> secDocNames, final List<SBMLDocument> secDocs) {
