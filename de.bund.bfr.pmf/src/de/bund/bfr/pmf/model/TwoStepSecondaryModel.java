...
/**
 * Case 2a. Includes a {@link SBMLDocument} for the secondary model (master) and n primary models
 * with data.
 * 
 * @author Miguel Alba
 */
public class TwoStepSecondaryModel {
  ...
  public TwoStepSecondaryModel(final String secDocName, final SBMLDocument secDoc,
      final List<PrimaryModelWData> primModels) {
