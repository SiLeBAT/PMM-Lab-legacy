...
public class NuMLDocument {
	...
	public NuMLDocument(Element node) {
		NodeList ontologyNodes = node.getElementsByTagName(ConcentrationOntology.ELEMENT_NAME);
		...
		NodeList resultComponentNodes = node.getElementsByTagName(ResultComponent.ELEMENT_NAME);
		Element resultComponentElement = (Element) resultComponentNodes.item(0);
