...
public class SBMLFactory {
  ...
  public static PMFCompartment createPMFCompartment(String id, String name, String pmfCode,
      String detail, ModelVariable[] modelVariables) {
  ...
  public static PMFSpecies createPMFSpecies(String compartment, String id, String name,
      String substanceUnits, String combaseCode, String detail, String description) {
    return new PMFSpeciesImpl(compartment, id, name, substanceUnits, combaseCode, detail,
        description);
  }
  ...
  public static Reference createReference(String author, Integer year, String title,
      String abstractText, String journal, String volume, String issue, Integer page,
      Integer approvalMode, String website, ReferenceType referenceType, String comment) {
  ...
  public static Uncertainties createUncertainties(Integer id, String modelName, String comment,
      Double r2, Double rms, Double sse, Double aic, Double bic, Integer dof) {
