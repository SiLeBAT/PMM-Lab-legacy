...
public class SecDep {
  ...
  /** Builds a {@link SecDep} from a {@link Parameter} which can be annotated. */
  public SecDep(final Parameter param) {
  ...
  public SecDep(final String name, final String desc, final String unit) {
...
class SecDepAnnotation {
  ...
  public SecDepAnnotation(final Annotation annotation) {
  ...
  public SecDepAnnotation(final String desc) {
