 ...
 */
@Entity
@Table(name = "Codes_Agenzien")
public class JPACodesAgenzien implements Serializable{

	private static final long serialVersionUID = 6628396218151039611L;
    ...
    public boolean equals(Object o) {
        ...
        JPACodesAgenzien that = (JPACodesAgenzien) o;

        if (basis != that.basis) return false;
	...
	public JPAAgenzien getBasis() {
		return basis;
	}

	public void setBasis(JPAAgenzien basis) {
		this.basis = basis;
	}
}
