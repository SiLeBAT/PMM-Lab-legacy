 ...
 *
 */
public class SymptomeFPAImporter extends FileFilter implements MyImporter {
  /**
 ...
 */
	...
	public String getDescription() {
	    return "Symptome-FPAdvisor Datei (*.xls; *.xlsx)";
	}
	...
	public void doImport(final String filename, final JProgressBar progress, final boolean showResults) {
      ...
      public void run() {
            ...
            progress.setString("Importiere Symptome-FPAdvisor Datei...");
      			progress.setMinimum(0);
      			progress.setMaximum(96);
      			progress.setValue(0);
      		}
	    	...
	    	if (filename.startsWith("http://")) {
		      ...
		      sheet = wb.getSheet("Tabelle1");      
		      PreparedStatement ps = DBKernel.getDBConnection().prepareStatement("INSERT INTO " + DBKernel.delimitL("Symptome") +
		      		" (" + DBKernel.delimitL("Bezeichnung_engl") + ") VALUES (?)");
		      ...
		      while( rows.hasNext() ) {
    			...
    			if (progress != null) {
    				...
    				if (myDB.getActualTable() != null) {
  					...
  					System.out.println("SymptomeFPAImporter - Fin");
  				}
		    }
