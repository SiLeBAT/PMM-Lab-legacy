 ...
 * $HeadURL: http://data-in-motion.biz/statup/trunk/de.dim.bfr.ui/src/de/dim/bfr/ui/databinding/converter/String2IntegerConverter.java $
...
/**
 * Converts a string into a integer value. If there <code>null</code> values or
 * empty strings, they will be converted into <code>null</code> 
 * @author Mark Hoffmann
 * @since 28.11.2011
 */
public class String2IntegerConverter implements IConverter {
