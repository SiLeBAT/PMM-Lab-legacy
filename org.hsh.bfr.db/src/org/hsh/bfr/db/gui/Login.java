...
public class Login extends JFrame {
			...
			if (noDBThere) {
				...
				if (answer == JOptionPane.YES_OPTION) {
					...
					if (DBKernel.myDBi != null && DBKernel.myDBi.getConn() != null) {
						...
						else {  // Passwort hat sich ver�ndert innerhalb der 2 beteiligten Datenbanken...
							passwordField1.setBackground(Color.RED);
							passwordField2.setBackground(Color.WHITE);
							passwordField3.setBackground(Color.WHITE);
							passwordField1.requestFocus();
	...
	private int askVeraltetDBBackup(MyDBI myDBi) {
		...
		if (retVal == JOptionPane.YES_OPTION) {
			...
			retVal = JOptionPane.showConfirmDialog(this, "Die Datenbank wirklich ohne Backup �berschreiben?? Sicher?", "Sicher?", JOptionPane.YES_NO_OPTION,
