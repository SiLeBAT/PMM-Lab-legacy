...
public class MainFrame extends JFrame {
	...
	private void button11ActionPerformed(final ActionEvent e) {
		// reset Database:
		int retVal = JOptionPane.showConfirmDialog(this, "Sind Sie sicher, da� Sie die Datenbank neu initialisieren m�chten?", "Reset best�tigen", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
