    ...
    try {
      ...
      this.addAncestorListener(new AncestorListener() {
    	  public void ancestorAdded(AncestorEvent e) {
    		  ...
    		  public void ancestorRemoved(AncestorEvent e) { // oben rechts das x gedr�ckt zum Schliessen
...
*/
  ...
  public void addCellEditorListener(CellEditorListener l) {
    ...
    // alle KeyEvents au�er Alt+Enter, Strg+Enter, damit soll was anders passieren, n�mlich die abgespeicherte Datei ge�ffnet werden
  ...
  public boolean isCellEditable(EventObject anEvent) {
	  if (anEvent == null) { // null wird �bergeben bei selectCell(row, column) in der Funktion setSelectedRowCol in MyDBTable
		  return false;
	  }
	  else {
