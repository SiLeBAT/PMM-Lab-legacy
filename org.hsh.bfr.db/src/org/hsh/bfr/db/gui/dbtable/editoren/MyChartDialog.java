...
class MyChartDialog extends JDialog {
	...
	private void button4ActionPerformed(ActionEvent e) {
		String hilfe = "In der linken Spalte der Tabelle k�nnen einzelne Punkte f�r die x-Achse angegeben werden.\n" +
			"In der rechten Spalte die zugeh�rigen Werte.\n" +
			"Es ist m�glich f�r die x-Achse Intervalle einzugeben mit '-' als Trennzeichen (z.B. 3-5).\n" +
			"Au�erdem ist es m�glich verschiedene Einheiten f�r Zeiten anzugeben, z.B. 3d 13h 13m 5s\n" +
			"F�r die y-Achse k�nnen einfache Zahlen angegeben werden oder auch Funktionen (mit x als Variable),\n" +
