 ...
 *
 */
public class MethodenADVImporterDOC extends FileFilter implements MyImporter {
	...
	public String getDescription() {
	    return "Methoden_ADV Datei (*.doc; *.docx)";
	}
	...
	public void doImport(final String filename, final JProgressBar progress, final boolean showResults) {
      ...
      public void run() {
            ...
            progress.setString("Importiere Methoden_ADV...");
		      ...
		      for( int i=0; i<paragraphs.length; i++ ) {
    			...
    			if (progress != null) {
    				...
    				System.out.println("MethodenADVImporterDOC - Fin");
    			}
		    }
